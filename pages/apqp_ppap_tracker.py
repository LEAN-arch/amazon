...
with tab_deepdive:
    ...
    # Simulate PPAP element data for the selected part
    ppap_elements = [
    ...
    with col1:
        ...
        pfmea_df["RPN"] = pfmea_df["S"] * pfmea_df["O"] * pfmea_df["D"]
        st.dataframe(
    ...
    with col2:
        ...
        # Simulate Gage R&R Results
        gage_results = {
            "Source of Variation": ["Repeatability (EV)", "Reproducibility (AV)", "Total Gage R&R", "Part-to-Part"],
            "% Contribution": [7.5, 4.2, 11.7, 88.3]
        }
        ...
        fig_gage = go.Figure(go.Indicator(
            ...
            gauge = {
                ...
                'steps': [
                    ...
                    {'range': [1, 9], 'color': 'yellow'},
                    {'range': [9, 30], 'color': 'red'}],
