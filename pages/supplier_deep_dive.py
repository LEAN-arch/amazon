...
with tab_monitor:
    ...
    with col2:
        ...
        """)
        # Simulate process data and spec limits
        usl, lsl = 10.6, 9.4
...
with tab_act:
    ...
    - **Why:** This automates a critical communication workflow. A formal SCAR is a key part of any **ISO 9001 / AS9100** compliant quality system. This tool ensures that requests for corrective action are always data-driven, professional, and standardized, fulfilling the "effective written and verbal communication" requirement of the role.
    """)

    st.subheader("Generate Supplier Corrective Action Request (SCAR)")
    non_conformance_details = st.text_area(
        "Describe the Non-Conformance (Be specific)", 
        "During incoming inspection of Lot #A-LOT-7891, 15 out of 1000 units exhibited wire bond lift failures on Pad 14, resulting in a lot rejection."
    )
    
    standard_ref = st.selectbox(
        "Reference to Quality Standard Requirement",
        [
            "AS9100D Clause 8.4.3: Information for External Providers",
            "IPC-A-610 Class 3: Acceptance Criteria for Wire Bonds",
            "JEDEC JESD22-B116: Wire Bond Shear Test Method",
